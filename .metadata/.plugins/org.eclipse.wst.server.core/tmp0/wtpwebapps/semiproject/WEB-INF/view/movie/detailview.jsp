			...
			<div class="mv_info_bottom_left">
				<div class="mv_info_simdo-review-wrapper">
					...
					<div class="mv_review_wrap">
						<div class="mv_review">
							<span class="name">코끼리</span>
							<span class="review">김민희랑 김태리랑 너무 잘어울리는 영화였어요!</span>
						</div> 
					</div>
					<div class="mv_review_wrap">
						<div class="mv_review">
							<span class="name">토끼</span>
							<span class="review">이런 반전이 있을 줄 전혀 몰랐습니다. 재밌어요!</span>
						</div> 
					</div>
					<div class="mv_review_wrap">
						<div class="mv_review">
							<span class="name">추천교수</span>
							<span class="review">안본눈 삽니다. 다시 처음부터 또 보고 싶어요ㅠㅠ</span>
						</div> 
					</div>
				</div>
			</div>
